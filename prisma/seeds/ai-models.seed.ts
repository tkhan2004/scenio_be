...
const AI_MODELS: SeedAiModel[] = [
  ...
  ]),
  {
    ...
    description: 'OpenAI current realtime speech-to-speech model.',
  ...
  },
  {
    ...
    description: 'OpenAI realtime fallback model used by older Scenio flows.',
    inputModalities: ['AUDIO', 'TEXT'],
    outputType: 'AUDIO_TEXT',
    dimensionOptions: [],
    defaultDimension: null,
...
const DEFAULT_SETTINGS = [
  ...
  {
    featureType: AiFeatureType.ROLEPLAY_LLM,
    primary: [AiProvider.ANTHROPIC, 'claude-sonnet-4-6'] as const,
    fallbacks: [
  ...
  },
  {
    ...
    fallbacks: [
      [AiProvider.OPENAI, 'gpt-5.4-mini'] as const,
      [AiProvider.GOOGLE, 'gemini-2.5-flash'] as const,
      [AiProvider.OPENAI, 'gpt-4o-mini'] as const,
    ],
    outputDimension: null,
  },
  {
    ...
    fallbacks: [[AiProvider.OPENAI, 'gpt-realtime'] as const],
    outputDimension: null,
  },
  {
    featureType: AiFeatureType.TTS,
    primary: [AiProvider.ELEVENLABS, 'eleven_flash_v2_5'] as const,
    fallbacks: [
      [AiProvider.OPENAI, 'gpt-4o-mini-tts'] as const,
